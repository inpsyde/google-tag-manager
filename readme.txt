...
2. Open the header.php of your theme, find the opening `<body>` tag and then add the code
   `<? php do_action( "inpsyde-google-tag-manager.render-noscript" ); ?>`.
...
*Example:* To access the user role with a GTM data layer variable, enter the user role `user.role`.
